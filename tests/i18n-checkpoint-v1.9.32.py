...
check("Web: DEFAULT_LANG == zh", '"zh"' in web_i18n_source and "DEFAULT_LANG" in web_i18n_source)
...
check("Cross: both default zh", bot.DEFAULT_LANG == "zh" and "DEFAULT_LANG" in web_i18n_source)
check("Cross: both have invalid fallback", bot.normalize_lang("invalid") == "zh" and web_normalize_lang("invalid") == "zh")
