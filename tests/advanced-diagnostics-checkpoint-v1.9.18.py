...
check("Both do not gate Raw JSON yet", "advanced_mode" not in bot_source.split("cmd_status_json")[1].split("async def")[0] if "cmd_status_json" in bot_source else False)
